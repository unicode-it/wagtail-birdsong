# Generated by Django 3.2.16 on 2023-03-07 15:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('double_opt_in_enabled', models.BooleanField(default=False, verbose_name='Enable double opt-in')),
                ...
                ('campaign_unsubscribe_success', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailcore.page', verbose_name='Success page for unsubscription')),
            ],
            options={
